...
# Islamic chanting or sighs synchronized with other loops
define :islamic_chant do |initial=false|
  sample "/Users/hhsadiq/Music/Studio/Sonic Pi/ambient soothing sound with hassaan ahaat/ahaat2.wav", amp: 3, attack: 2, release: 2
  sleep 16
end
...
# Synchronize Islamic chant with other loops
sleep 2 # Ensure this is long enough to cover the initial fade-ins
live_loop :islamic_chant_loop do
  islamic_chant tick == 0
end
