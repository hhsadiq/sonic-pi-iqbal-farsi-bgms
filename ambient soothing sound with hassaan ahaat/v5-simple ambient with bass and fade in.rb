...
define :soft_chords do
  ...
  chord1 = play_chord choose([[:c4, :e4, :g4],
                              ...
                              [:d4, :f4, :a4],
                              [:e3, :g3, :b3],
                              [:f3, :a3, :c4]]), sustain: 8, amp: 0
  fade_in chord1, 2, 1.2 # Softer volume for chords
  sleep 8
  chord2 = play_chord choose([[:a3, :c4, :e4],
                              [:b3, :d4, :f4],
                              [:g3, :b3, :d4],
                              [:c3, :e3, :g3],
                              [:d3, :f3, :a3]]), sustain: 8, amp: 0
  fade_in chord2, 2, 1.2 # Softer volume for chords
  sleep 8
end
...
define :soft_bass do
  use_synth :fm
  bass1 = play choose([:c2, :a2, :d2]), release: 8, amp: 0
  fade_in bass1, 2, 2 # More prominent bass
  sleep 8
  bass2 = play choose([:g2, :b2, :f2]), release: 8, amp: 0
  fade_in bass2, 2, 2 # More prominent bass
  sleep 8
end
